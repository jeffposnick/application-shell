...
<div>${item.body}</div>
<div>
  <img crossorigin="anonymous" class="profile" src="${item.owner.profile_image}" title="Profile image for ${item.owner.display_name}">
...
<div>
  <img crossorigin="anonymous" class="profile" src="${answer.owner.profile_image}" title="Profile image for ${answer.owner.display_name}">
